...
impl core::fmt::Debug for TrackerDataSupport {
...
impl<'a> flatbuffers::Follow<'a> for TrackerDataSupport {
  type Inner = Self;
  #[inline]
...
impl flatbuffers::Push for TrackerDataSupport {
    type Output = TrackerDataSupport;
    #[inline]
...
impl flatbuffers::EndianScalar for TrackerDataSupport {
  type Scalar = u8;
  #[inline]
...
impl<'a> flatbuffers::Verifiable for TrackerDataSupport {
  #[inline]
  fn run_verifier(
...
impl flatbuffers::SimpleToVerifyInSlice for TrackerDataSupport {}
